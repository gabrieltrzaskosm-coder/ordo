...
export async function submitDiagnostic(
  ...
  const text = [
    ...
    `Perspectiva estimada de aumento de lucros no 1º mês: ${analysis.profitPerspectiveFirstMonth}%`,
    `Perspectiva estimada de aumento de lucros no 2º mês: ${analysis.profitPerspectiveSecondMonth}%`,
    `Perfil: ${profile}`,
