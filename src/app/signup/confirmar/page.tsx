...
export default function ConfirmarPage() {
  return (
    <main className="mx-auto flex min-h-screen max-w-sm flex-col justify-center p-6">
      <h1 className="text-xl font-medium">Confirme o seu email</h1>
      <p className="mt-2 text-sm text-neutral-500">
        Enviámos-lhe um link de confirmação. Abra-o para ativar a conta e entrar
        na gestão do seu restaurante.
      </p>
